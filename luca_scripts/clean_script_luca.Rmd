...
summary(nudi_data_factor$mean_vel[nudi_data_factor$temp_grp=="16"]) 0.00141
summary(nudi_data_factor$mean_vel[nudi_data_factor$temp_grp=="18"]) 0.00146
```
```{r}
#trying out boxplot with residuals of gamma model
