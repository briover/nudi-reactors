...
ggsave(plot =boxplot_nudi, filename = here("luca_scripts", "perfectplot.png"), bg = "white", width = 6, height = 4)
```
...
#save as picture
ggsave(plot = nudi_vel_length, filename = here("luca_scripts","lm_length_vel2.png"), width = 6, height = 4, bg="white")
